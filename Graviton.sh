...
BVER=`dmidecode -t bios | grep "Version" | awk '{print $2}'| sed -e 's/-dev//'`
...
PNU_FRU=`ipmitool fru print 0 | grep "Product Part Number" | awk '{print $5}'`
PV_FRU=`ipmitool fru print 0 | grep "Product Version" | awk '{print $4}' | sed 's/://'`
PS_FRU=`ipmitool fru print 0 | grep "Product Serial" | awk '{print $4}' | sed 's/://'`
